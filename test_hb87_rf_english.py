...
def test_hb87_rf_logic():
    ...
    for _, row in detail.iterrows():
        ...
        try:
            ...
            print(f"  Dispatch_Remark: [Contains Chinese characters]")
        ...
        if site == "HB87" and rp_type == "RF" and site_promo_demand <= 0:
            ...
            try:
                ...
                print(f"  [INFO] Dispatch_Remark contains Chinese characters")
        ...
        for _, row in hb87_rf_cases.iterrows():
            ...
            if raw_value > 0 and moq > 0:
                ...
                try:
                    ...
                    print(f"  Remark: [Contains Chinese characters]")
                ...
                try:
                    ...
                    print(f"  [INFO] Cannot verify remark due to encoding")
                print()
    else:
