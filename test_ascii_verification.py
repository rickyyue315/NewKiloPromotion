...
def test_dispatch_logic():
    """Test dispatch type logic with various scenarios"""
    
    # Test cases focusing on ND sites with Suggested_DN_Qty = 0
    test_cases = [
    ...
    print("Testing Dispatch_Type Logic for ND sites:")
    print("=" * 60)
    ...
    if all_passed:
        ...
        print("The fix correctly ensures that when Suggested_DN_Qty is 0,")
        print("ND sites show '無須補貨' instead of '需生成 DN'.")
    else:
